...
import Shioyaki from '../assets/images/food/Shioyaki.png'
import Ikayaki from '../assets/images/food/Ikayaki.png'
import Onigiri from '../assets/images/food/Onigiri.png'
import Cabbage_Salad from '../assets/images/food/Salad.png'
import Taiyaki from '../assets/images/food/Taiyaki.png'
import Dorayaki from '../assets/images/food/Dorayaki.png'
import Daikon_Salad from '../assets/images/food/Daikon.png'
import Sushi from '../assets/images/food/Sushi.png'
import Ebi_Furai from '../assets/images/food/Ebi_Furai.png'
import Takoyaki from '../assets/images/food/Takoyaki.png'
import Ultimate_secret_bowl from '../assets/images/food/Ultimate_secret_bowl.png'
import Mackerel from '../assets/images/ingredients/Meat/Mackerel.png'
import Octopus from '../assets/images/ingredients/Meat/Octopus.png'
...
import Anko from '../assets/images/ingredients/Seasonings/Anko.png'
import Mayo from '../assets/images/ingredients/Seasonings/Mayonnaise.png'
import Salt from '../assets/images/ingredients/Seasonings/Salt shaker.png'
import Seaweed from '../assets/images/ingredients/Seasonings/Seaweed plate.png'
import Soy_Sauce from '../assets/images/ingredients/Seasonings/Soy sauce.png'
...
import Meat_Btn from '../assets/images/kitchen/Btn_Meat.png'
import Meat_Bar from '../assets/images/kitchen/Bar_Meat.png'
import Seasoning_Btn from '../assets/images/kitchen/Btn_Seasoning.png'
import Seasoning_Bar from '../assets/images/kitchen/Bar_Seasonings.png'
import Others_Btn from '../assets/images/kitchen/Btn_Others.png'
...
export default class MainScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.textures.addBase64('Cabbage_Salad', Cabbage_Salad);
        this.textures.addBase64('Taiyaki', Taiyaki);
        this.textures.addBase64('Dorayaki', Dorayaki);
        this.textures.addBase64('Daikon_Salad', Daikon_Salad);
        this.textures.addBase64('Sushi', Sushi);
        this.textures.addBase64('Ebi_Furai', Ebi_Furai);
        this.textures.addBase64('Takoyaki', Takoyaki);
        this.textures.addBase64('Ultimate_secret_bowl', Ultimate_secret_bowl);
        ...
        this.textures.addBase64('Squid', Squid);
        this.textures.addBase64('Liquid_Dough', Liquid_Dough);
        this.textures.addBase64('Panko', Panko);
        this.textures.addBase64('Rice', Rice);
        this.textures.addBase64('Tenkasu', Tenkasu);
        this.textures.addBase64('Anko', Anko);
        this.textures.addBase64('Mayo', Mayo);
        this.textures.addBase64('Salt', Salt);
        this.textures.addBase64('Seaweed', Seaweed);
        this.textures.addBase64('Soy_Sauce', Soy_Sauce);
        this.textures.addBase64('Cabbage', Cabbage);
        this.textures.addBase64('Daikon_Chopped', Daikon_Chopped);
        this.textures.addBase64('Spring_Onion', Spring_Onion);
        //KITCHEN
        this.textures.addBase64('Plate', Plate);
        this.load.spritesheet('Cookware', Cookware_Spritesheet, {
            frameWidth: 390,
            frameHeight: 300
        });
        this.textures.addBase64('Nothing', Nothing);
        this.textures.addBase64('Pot', Pot);
        this.textures.addBase64('Fryer', Fryer);
        this.textures.addBase64('Meat_Btn', Meat_Btn);
        this.textures.addBase64('Meat_Bar', Meat_Bar);
        this.textures.addBase64('Seasoning_Btn', Seasoning_Btn);
        this.textures.addBase64('Seasoning_Bar', Seasoning_Bar);
        this.textures.addBase64('Others_Btn', Others_Btn);
